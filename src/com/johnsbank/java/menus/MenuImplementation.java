 ...
 */
public final class MenuImplementation {

    // Used to access the service call in the application
    private static final BankService service = BankServiceImplementation.getInstance();
    // Used to generate hashes from objects
    ...
    /**
     * Given a user, opens the user menu which allows that user to select what they wish to do
     * @param user - The user operating the menu
     */
    ...
    private static void viewAccounts(User user) {
        ...
        // Accesses the specified account belonging to the user
        accessAccount(user, user.getAccounts().get(--optionSelected));
    }

    /**
     * Given a user, walks the user through opening a new Bank Account
     * @param user - The user opening a new bank account
     */
    ...
    /**
     * Opens the menu that allows the user to add an owner to the bank account
     * @param account - the account that will have a new owner
     */
    ...
    /**
     * A Helper function used to set the name of the user being registed
    ...
    /**
     * Helper function that is used to set the contact info for a new user
     * @param newUser - the new user object being registered
     */
    ...
    /**
     * A Helper function used to set the SSN for the new user
     * @param newUser - The new user registering the new account
     */
    ...
    /**
     * Helper function that sets a username for a new account
     * @param newUser - The new user setting up an account
     */
    ...
    /**
     * Helper function that sets a password for a new account
     * @param newUser - The new user being registered
     */
    ...
    /**
     * A Helper function that takes a user input and a new account to set the Account Type
     * @param optionSelected - The option the user selected
     * @param newAccount - the new account that is being opened
     * @return - True if the Type was set properly, false if not
     */
    ...
    /**
     * A Helper function that sets a unique ID for Accounts to be used in the database
     * @param newAccount - The new account to be assigned a unique ID
     */
    private static void setUniqueID( Account newAccount) {
        ...
        uniqueId.append(newAccount.getType().toString());
    ...
    /**
     * A Helper function that asks the user if an account is joint
     * @return - Whether the new account is joint
     */
    ...
    /**
     * Helper function that takes an account and asks the user which users to add as a joint-owner
     * @param user - The user opening a new account
     * @param newAccount - The account being open
     * @param isJoint - whether the user indicated the account is a joint-account
     */
    ...
    /**
     * Helper function that allows the user to confirm opening a new account
     * @param newAccount - The account in question
     * @return - true if the user decides to confirm opening the account, false otherwise
     */
    static private boolean confirmAccount( Account newAccount) {
        while(true)
        {
            System.out.print("\nDo you wish to confirm opening " +
                    newAccount.getType().toString() + " account? (Y/n): ");
            String input = scan.nextLine();
            if(input.equalsIgnoreCase("y") || input.equalsIgnoreCase("yes"))
                return true;
    ...
    /**
     * Validates the input of an arbitrary field
     * @param nameOfInput - name that describes the input to the user
     * @param forms - array of Strings that has the various forms the input can be in
     * @param method - the method used to validate the input
     * @return - returns a string in the proper form
     */
    ...
    /**
     * Used with the command pattern to validate user input
     */
    ...
    /**
     * Class implementing a command pattern that validates email addresses
     */
    static private class EmailValidator implements Validator {
        /**
         * Given a string validates that it is in proper from for email addresses
         * @param email - the string in question
         * @return - true if the string is in proper format, false otherwise
         */
    ...
    /**
     * Class implementing a command pattern that validates addresses
     */
    static private class AddressValidator implements Validator {
        /**
         * Given a string validates that it is in proper form
         * @param address the string in question
    ...
    /**
     * A Validator class used in the command pattern to validate zipcodestrings
     */
    static private class ZipcodeValidator implements Validator {


        /**
         * Given Given a string, determines whether it is in the correct format for zipcodes or not
         * @param zipCode - The string to look at
         * @return - Returns true if the string is in the right format, false otherwise
         */
    ...
    /**
     * Class that uses the command pattern that implements validation of State Codes
     */
    static private class StateValidator implements Validator {
        /**
         * Given a string determines if the string is a proper State/Territory code
         * @param state - The state in question
         * @return - Returns true if it is in a proper form, false otherwise
         */
    ...
    /**
     * A validator used to determine if a string is a propper SSN
     */
    static private class SSNValidator implements Validator {
        /**
         * Given a String tells if it is a proper SSN
         * @param SSN - The SSN to check
         * @return - Returns true if it is a proper SSN, false otherwise
         */
    ...
    /**
     * Given a string tells you whether it is in the correct form for a username or not
     */
    static private class UsernameValidator implements Validator {
        /**
         * Given a String tells whether it is in the correct format or not
    ...
    /**
     * Class that validates whether a phone number is in the correct form or not
     */
    static private class PhoneValidator implements Validator {

        /**
         * Given a phone number returns true if it is in the correct format
         * @param phoneNumber - The Phone number to test
         * @return Returns true if the phone number is correctly formatted, false otherwise
         */
    ...
    /**
     * A class that validates whether a password is in the correct form or not
     */
    static private class PasswordValidator implements Validator {

        /**
         * Given a password as a string, returns whether the password is in the correct from or not
         * @param password - The password to test
         * @return Returns True if the password is correctly formatted
         */
